...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <?php if (in_array($student['form_template'] ?? '', ['sgvu', 'amity', 'mangalayatan', 'svsu', 'dypatil', 'smu', 'vgu', 'preetiglobal', 'lpu_international', 'manipal_jaipur', 'bosse', 'chandigarh', 'sabarmati'], true)): ?>
